...
public class BinaryFileManager {
    ...
    public BinaryFileManager(String filePath){
        ...
        File parentDir = binaryFile.getAbsoluteFile();
        if (parentDir != null && !parentDir.exists()){
            parentDir.mkdirs();
            System.out.println("[BINARY] Created directory: " + parentDir.getAbsoluteFile());
        }
        try {
            if (!binaryFile.exists()){
                binaryFile.createNewFile();
                System.out.println("[BINARY] Created file: " + binaryFile.getAbsoluteFile());
            }
        }catch (IOException e){
    ...
    public void displayFileProperties(){
        ...
        System.out.println(" Path: " + binaryFile.getAbsoluteFile());
